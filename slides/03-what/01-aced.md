...
{Logan} Comme tous les modèles, il est faux, ou plus exactement incomplet. Mais il est TRES utile.
...
**TRANSITION** En l'occurence, pour elle, l'architecture relève du pourquoi technique : Pourquoi utilise-t-on un langage, une base de données et non pas du comment...
